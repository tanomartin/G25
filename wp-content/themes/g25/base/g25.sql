...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2018 a las 15:56:59
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1288 ;
...
(162, 'tribe_last_save_post', '1544108166', 'yes'),
...
(1268, '_transient_timeout_feed_mod_0d102f2a1f4d6bc90eb8c6ffe18e56ed', '1544145148', 'no'),
(1269, '_transient_feed_mod_0d102f2a1f4d6bc90eb8c6ffe18e56ed', '1544101948', 'no'),
...
CREATE TABLE IF NOT EXISTS `g25_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1766 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=326 ;
