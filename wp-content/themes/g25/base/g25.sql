...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-12-2018 a las 01:33:10
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1336 ;
...
(1322, '_site_transient_timeout_theme_roots', '1544137750', 'no'),
(1323, '_site_transient_theme_roots', 'a:1:{s:3:"g25";s:7:"/themes";}', 'no'),
...
(162, 'tribe_last_save_post', '1544142298', 'yes'),
...
CREATE TABLE IF NOT EXISTS `g25_postmeta` (
  ...
  KEY `post_id` (`post_id`),
  KEY `meta_key` (`meta_key`(191))
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1913 ;
...
(310, 101, '_edit_lock', '1544142684:1'),
...
(1824, 332, '_edit_lock', '1544121786:1'),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=342 ;
...
(32, 1, '2018-10-01 14:06:25', '2018-10-01 17:06:25', 'Parrafo de nota 4\r\n\r\nParrafo segundo de nota 4', 'Nota 4', '', 'publish', 'open', 'open', '', 'nota-4', '', '', '2018-12-06 14:30:10', '2018-12-06 17:30:10', '', 0, 'http://localhost/G25/?p=32', 0, 'post', '', 0),
