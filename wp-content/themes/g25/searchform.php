...
function control(formulario) {
	...
	<form class="form-inline my-2 my-lg-0" method="get" id="searchform" onsubmit="return control(this)" action="<?php echo esc_url( home_url( '/' ) ); ?>" autocomplete="off">
		...
		<button style="background-color: transparent; border: none;display:inline-block;" type="submit" name="submit" id="searchsubmit" value="<?php esc_attr_e( 'Search', 'g25' ); ?>" ><i class="fas fa-search"></i></button>
	</form>
