      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-left mx-auto">
            ...
            <h4><?php echo $wp_query->found_posts; ?> <?php _e( 'Resultado encontrado para Tag Geografico', 'locale' ); ?>: "<?php single_cat_title(); ?>" </h4>
          </div>
...
$wp_query->query('showposts=2'.'&paged='.$paged.'&cat='.$cat_id);
?>
