...
<html lang="en">
	<head>
	    ...
	    <link href="<?php echo THEME_URL ?>/vendor/fontawesome-free/css/all.min.css" rel="stylesheet">
	    <link href="<?php echo THEME_URL ?>/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet" type="text/css">
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  <a class="navbar-brand" href="<?php echo SITE_URL;?>">
	    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	       viewBox="0 0 176.1 79.6" style="enable-background:new 0 0 176.1 79.6;width:100px;" xml:space="preserve">
	    <g>
	      <path style="fill:#F5B11A;" d="M4.1,40.6v-0.2c0-18.6,14.5-33.9,34.3-33.9c9.9,0,16.5,2.2,22.4,6.4c1.4,1,3,3,3,5.8
	      ...
	      <path style="fill:#00B8F1;" d="M120.9,67c0,3.7-2.9,6.6-6.7,6.6H78.7c-4.9,0-8.2-2.9-8.2-7.2c0-2.9,1.3-5.4,3.9-7.5L93,43.6
	      ...
	      <path style="fill:#EE4A6D;" d="M150.1,30.5c-3.6,0-6,0.5-8.6,1.1l0.7-11.3h22.1c3.5,0,6.4-2.8,6.4-6.3s-2.9-6.4-6.4-6.4h-28.4
