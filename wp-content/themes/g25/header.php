...
<!-- Bootstrap core CSS -->
<link
	href="<?php echo THEME_URL ?>/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<!-- Custom fonts for this template -->
<link
	href="<?php echo THEME_URL ?>/vendor/fontawesome-free/css/all.min.css"
	rel="stylesheet">
<link
	href="<?php echo THEME_URL ?>/vendor/simple-line-icons/css/simple-line-icons.css"
	rel="stylesheet" type="text/css">
<link
	href="https://fonts.googleapis.com/css?family=Lato:300,400,700,300italic,400italic,700italic"
	rel="stylesheet" type="text/css">
<!-- Custom styles for this template -->
<link href="<?php echo THEME_URL ?>/css/landing-page.css"
	rel="stylesheet">
<link href="<?php echo THEME_URL ?>/css/style.css" rel="stylesheet">
</head>

<nav class="navbar navbar-expand-lg navbar-light bg-light">
	<a class="navbar-brand" href="<?php echo SITE_URL;?>"> <svg
